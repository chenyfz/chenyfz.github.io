...
<template>
  <div class="cv-component full-cv">
    <h3 class="m-0 mt-3 mb-1">{{ t('education.title') }}</h3>
    <section class="mb-6">
      <div class="master">
        <div class="min-[840px]:flex min-[840px]:justify-between font-semibold mt-2">
          <div>{{ t('education.master.degree') }}</div>
          <div>{{ t('education.master.time') }}</div>
        </div>
        <div class="min-[840px]:flex min-[840px]:justify-between">
          <div><rich-text :text="t('education.master.university')" /></div>
          <div class="hidden min-[840px]:inline">
    ...
    <hr>
    <h3 class="m-0 mt-3 mb-1">{{ t('experience.title') }}</h3>
