...
<template>
  <div class="grid gap-6 max-w-4xl mx-auto mt-4 mb-16 px-page">
    <home-avatar-bar />

    <router-link to="/cv" class="card">
      <short-cv class="mb-2" />
    ...
    <section>
      ...
      <div class="grid grid-cols-2 max-md:grid-cols-1 gap-3 max-md:gap-4 mt-4">
        <!-- Graduation Project -->
        <router-link to="/graduation-thesis" class="card">
          <div v-if="t('master.graduationProject.badge')" class="absolute -top-px -right-px bg-primary text-white px-3 py-1 rounded-bl rounded-tr text-sm font-semibold">
            {{ t('master.graduationProject.badge') }}
          </div>
          <div class="mb-4">
            <h3 class="text-lg font-semibold mb-1 mt-1">{{ t('master.graduationProject.title') }}</h3>
            <div class="text-muted text-sm">{{ t('master.graduationProject.subtitle') }}</div>
          </div>
          <p class="grow m-0 text-[15px]">{{ t('master.graduationProject.description') }}</p>
          <div class="link mt-4">{{ t('master.graduationProject.cta') }}</div>
        </router-link>

        <!-- Prototyping Project -->
        <router-link to="/snow-globe" class="card">
          <div class="mb-4">
            <h3 class="text-lg font-semibold mb-1 mt-1">{{ t('master.prototypingProject.title') }}</h3>
            <div class="text-muted text-sm">{{ t('master.prototypingProject.subtitle') }}</div>
          </div>
          <p class="grow m-0 text-[15px]">{{ t('master.prototypingProject.description') }}</p>
          <div class="link mt-4">{{ t('master.prototypingProject.cta') }}</div>
        </router-link>

        <!-- VR/AR/MR Project -->
        <router-link to="/multimodal-interaction" class="card">
          <div class="mb-4">
            <h3 class="text-lg font-semibold mb-1 mt-1">{{ t('master.vrArMrProject.title') }}</h3>
            <div class="text-muted text-sm">{{ t('master.vrArMrProject.subtitle') }}</div>
          </div>
          <p class="grow m-0 text-[15px]">{{ t('master.vrArMrProject.description') }}</p>
          <div class="link mt-4">{{ t('master.vrArMrProject.cta') }}</div>
        </router-link>

        <!-- Research Methods -->
        <div class="card bg-surface-50 hover:bg-surface-50">
          <div class="mb-4">
            <h3 class="text-lg font-semibold mb-1 mt-1">{{ t('master.researchMethods.title') }}</h3>
            <div class="text-muted text-sm" v-if="t('master.researchMethods.subtitle')">{{ t('master.researchMethods.subtitle') }}</div>
          </div>
          <p class="grow m-0 text-[15px]">{{ t('master.researchMethods.description') }}</p>
        ...
        <router-link to="/masters-courses" class="link col-span-full text-link py-1 mx-1">
    ...
    <section>
      ...
      <div class="card mt-4">
        ...
        <div class="interest-list">
          <div class="mt-4">
            <h4 class="font-semibold mt-0 mb-1">{{ t('future.interest1.title') }}</h4>
            <p class="mt-0">{{ t('future.interest1.description') }}</p>
          </div>
          <div class="mt-4">
            <h4 class="font-semibold mt-0 mb-1">{{ t('future.interest2.title') }}</h4>
            <p class="mt-0">{{ t('future.interest2.description') }}</p>
          </div>
          <div class="mt-4">
            <h4 class="font-semibold mt-0 mb-1">{{ t('future.interest3.title') }}</h4>
            <p class="mt-0">{{ t('future.interest3.description') }}</p>
          </div>
          <div class="mt-4">
            <h4 class="font-semibold mt-0 mb-1">{{ t('future.interest4.title') }}</h4>
            <p class="mt-0">{{ t('future.interest4.description') }}</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="mt-4 text-sm text-muted">
      {{ t('codebase')
        ...
        href="https://github.com/chenyfz/chenyfz.github.io"
        class="link"
        target="_blank"
      >
