...
<template>
  <div class="max-w-7xl mx-auto px-page my-8 mb-14">
    <h2 class="mb-1">{{ t('title') }}</h2>
    <div class="text-lg font-semibold text-muted mb-4">{{ t('title-subtitle') }}</div>
    <div class="card main-content-card py-6">
      <div class="overview grid grid-cols-[auto_1fr] gap-2 gap-x-[10px] text-content-70">
        <div class="full-line col-span-2 text-content text-xl font-bold">{{ t('contentTitle') }}</div>
        <div class="full-line col-span-2 text-content mt-3 font-bold">{{ t('firstYearTitle') }}</div>
        <div class="left">Period 1</div>
        <div class="right col-start-2 cursor-pointer w-fit px-1.5 relative rounded transition-all duration-100 hover:text-content hover:bg-highlight" :class="{ 'text-content bg-highlight': activeId === 'mcsp' }" @click="scrollToId('mcsp')">
          {{ t('mcsp.title') }}
        </div>
        <div class="right col-start-2 cursor-pointer w-fit px-1.5 relative rounded transition-all duration-100 hover:text-content hover:bg-highlight" :class="{ 'text-content bg-highlight': activeId === 'mlhvl' }" @click="scrollToId('mlhvl')">
          {{ t('mlhvl.title') }}
        </div>
        <div class="left">Period 2</div>
        <div class="right col-start-2 cursor-pointer w-fit px-1.5 relative rounded transition-all duration-100 hover:text-content hover:bg-highlight" :class="{ 'text-content bg-highlight': activeId === 'mvis' }" @click="scrollToId('mvis')">
          {{ t('mvis.title') }}
        </div>
        <div class="right col-start-2 cursor-pointer w-fit px-1.5 relative rounded transition-all duration-100 hover:text-content hover:bg-highlight" :class="{ 'text-content bg-highlight': activeId === 'mqlm' }" @click="scrollToId('mqlm')">
          {{ t('mqlm.title') }}
        </div>
        <div class="left">Period 3</div>
        <div class="right col-start-2 cursor-pointer w-fit px-1.5 relative rounded transition-all duration-100 hover:text-content hover:bg-highlight" :class="{ 'text-content bg-highlight': activeId === 'miti' }" @click="scrollToId('miti')">
          {{ t('miti.title') }}
        </div>
        <div class="right col-start-2 cursor-pointer w-fit px-1.5 relative rounded transition-all duration-100 hover:text-content hover:bg-highlight" :class="{ 'text-content bg-highlight': activeId === 'mmmi' }" @click="scrollToId('mmmi')">
          {{ t('mmmi.title') }}
        </div>
        <div class="left">Period 4</div>
        <div class="right col-start-2 cursor-pointer w-fit px-1.5 relative rounded transition-all duration-100 hover:text-content hover:bg-highlight" :class="{ 'text-content bg-highlight': activeId === 'mqnm' }" @click="scrollToId('mqnm')">
          {{ t('mqnm.title') }}
        </div>
        <div class="right col-start-2 cursor-pointer w-fit px-1.5 relative rounded transition-all duration-100 hover:text-content hover:bg-highlight" :class="{ 'text-content bg-highlight': activeId === 'mmob' }" @click="scrollToId('mmob')">
          {{ t('mmob.title') }}
        </div>

        <div class="full-line col-span-2 text-content mt-3 font-bold">{{ t('secondYearTitle') }}</div>
        <div class="left">Period 5</div>
        <div class="right col-start-2 cursor-pointer w-fit px-1.5 relative rounded transition-all duration-100 hover:text-content hover:bg-highlight" :class="{ 'text-content bg-highlight': activeId === 'mdm' }" @click="scrollToId('mdm')">
          {{ t('mdm.title') }}
        </div>
        <div class="left">Period 6</div>
        <div class="right col-start-2 cursor-pointer w-fit px-1.5 relative rounded transition-all duration-100 hover:text-content hover:bg-highlight" :class="{ 'text-content bg-highlight': activeId === 'mcm' }" @click="scrollToId('mcm')">
          {{ t('mcm.title') }}
        </div>
        <div class="left">Remaining</div>
        <div class="right col-start-2 cursor-pointer w-fit px-1.5 relative rounded transition-all duration-100 hover:text-content hover:bg-highlight" :class="{ 'text-content bg-highlight': activeId === 'thesis' }" @click="scrollToId('thesis')">
          {{ t('graduationThesis.title') }}
        </div>
      </div>
      <hr class="my-8">
      <div class="content mb-8">
        <div class="text-xl font-bold">{{ t('coursesTitle') }}</div>
        <div id="mcsp" class="course-section relative mt-8 scroll-mt-[72px]">
          <h4 class="mb-0 mt-4 cursor-pointer select-none">{{ t('mcsp.title') }}
            <span class="text-[15px] font-medium text-muted ml-2" v-if="$i18n.locale === 'en'">{{ t('gradeLabel') }}{{ t('mcsp.grade') }}</span>
            <span class="text-[15px] font-medium text-muted ml-2" v-else-if="$i18n.locale === 'zh'">{{ t('mcsp.grade') }}{{ t('gradeLabel') }}</span>
          </h4>
          <p>{{ t('mcsp.description') }}</p>
        </div>
        <div id="mlhvl" class="course-section relative mt-8 scroll-mt-[72px]">
          <h4 class="mb-0 mt-4 cursor-pointer select-none">{{ t('mlhvl.title') }}
            <span class="text-[15px] font-medium text-muted ml-2" v-if="$i18n.locale === 'en'">{{ t('gradeLabel') }}{{ t('mlhvl.grade') }}</span>
            <span class="text-[15px] font-medium text-muted ml-2" v-else-if="$i18n.locale === 'zh'">{{ t('mlhvl.grade') }}{{ t('gradeLabel') }}</span>
          </h4>
          <p>{{ t('mlhvl.description') }}</p>
        </div>
        <div id="mvis" class="course-section relative mt-8 scroll-mt-[72px]">
          <h4 class="mb-0 mt-4 cursor-pointer select-none">{{ t('mvis.title') }}
            <span class="text-[15px] font-medium text-muted ml-2" v-if="$i18n.locale === 'en'">{{ t('gradeLabel') }}{{ t('mvis.grade') }}</span>
            <span class="text-[15px] font-medium text-muted ml-2" v-else-if="$i18n.locale === 'zh'">{{ t('mvis.grade') }}{{ t('gradeLabel') }}</span>
          </h4>
          <p>{{ t('mvis.description') }}</p>
          <a href="https://superfashion.walzen.org/" class="link" target="_blank">{{ t('mvis.linkText') }}</a>
        </div>
        <div id="mqlm" class="course-section relative mt-8 scroll-mt-[72px]">
          <h4 class="mb-0 mt-4 cursor-pointer select-none">{{ t('mqlm.title') }}
            <span class="text-[15px] font-medium text-muted ml-2" v-if="$i18n.locale === 'en'">{{ t('gradeLabel') }}{{ t('mqlm.grade') }}</span>
            <span class="text-[15px] font-medium text-muted ml-2" v-else-if="$i18n.locale === 'zh'">{{ t('mqlm.grade') }}{{ t('gradeLabel') }}</span>
          </h4>
          <p>{{ t('mqlm.description') }}</p>
          <a href="/Group_30_Final_Paper.pdf" class="link" target="_blank">{{ t('mqlm.linkText') }}</a>
        </div>
        <div id="miti" class="course-section relative mt-8 scroll-mt-[72px]">
          <h4 class="mb-0 mt-4 cursor-pointer select-none">{{ t('miti.title') }}
            <span class="text-[15px] font-medium text-muted ml-2" v-if="$i18n.locale === 'en'">{{ t('gradeLabel') }}{{ t('miti.grade') }}</span>
            <span class="text-[15px] font-medium text-muted ml-2" v-else-if="$i18n.locale === 'zh'">{{ t('miti.grade') }}{{ t('gradeLabel') }}</span>
          </h4>
          <p>{{ t('miti.description') }}</p>
          <router-link to="/snow-globe" class="link">{{ t('miti.linkText') }}</router-link>
        </div>
        <div id="mmmi" class="course-section relative mt-8 scroll-mt-[72px]">
          <h4 class="mb-0 mt-4 cursor-pointer select-none">{{ t('mmmi.title') }}
            <span class="text-[15px] font-medium text-muted ml-2" v-if="$i18n.locale === 'en'">{{ t('gradeLabel') }}{{ t('mmmi.grade') }}</span>
            <span class="text-[15px] font-medium text-muted ml-2" v-else-if="$i18n.locale === 'zh'">{{ t('mmmi.grade') }}{{ t('gradeLabel') }}</span>
          </h4>
          <p>{{ t('mmmi.description') }}</p>
          <router-link to="/multimodal-interaction" class="link">{{ t('mmmi.linkText') }}</router-link>
        </div>
        <div id="mqnm" class="course-section relative mt-8 scroll-mt-[72px]">
          <h4 class="mb-0 mt-4 cursor-pointer select-none">{{ t('mqnm.title') }}
            <span class="text-[15px] font-medium text-muted ml-2" v-if="$i18n.locale === 'en'">{{ t('gradeLabel') }}{{ t('mqnm.grade') }}</span>
            <span class="text-[15px] font-medium text-muted ml-2" v-else-if="$i18n.locale === 'zh'">{{ t('mqnm.grade') }}{{ t('gradeLabel') }}</span>
          </h4>
          <p>{{ t('mqnm.description') }}</p>
          <a href="/infomqnm-report.pdf" class="link" target="_blank">{{ t('mqnm.linkText') }}</a>
        </div>
        <div id="mmob" class="course-section relative mt-8 scroll-mt-[72px]">
          <h4 class="mb-0 mt-4 cursor-pointer select-none">{{ t('mmob.title') }}
            <span class="text-[15px] font-medium text-muted ml-2" v-if="$i18n.locale === 'en'">{{ t('gradeLabel') }}{{ t('mmob.grade') }}</span>
            <span class="text-[15px] font-medium text-muted ml-2" v-else-if="$i18n.locale === 'zh'">{{ t('mmob.grade') }}{{ t('gradeLabel') }}</span>
          </h4>
          <p>{{ t('mmob.description') }}</p>
        </div>
        <div id="mdm" class="course-section relative mt-8 scroll-mt-[72px]">
          <h4 class="mb-0 mt-4 cursor-pointer select-none">{{ t('mdm.title') }}
            <span class="text-[15px] font-medium text-muted ml-2" v-if="$i18n.locale === 'en'">{{ t('gradeLabel') }}{{ t('mdm.grade') }}</span>
            <span class="text-[15px] font-medium text-muted ml-2" v-else-if="$i18n.locale === 'zh'">{{ t('mdm.grade') }}{{ t('gradeLabel') }}</span>
          </h4>
        ...
        <div id="mcm" class="course-section relative mt-8 scroll-mt-[72px]">
          <h4 class="mb-0 mt-4 cursor-pointer select-none">{{ t('mcm.title') }}
            <span class="text-[15px] font-medium text-muted ml-2" v-if="$i18n.locale === 'en'">{{ t('gradeLabel') }}{{ t('mcm.grade') }}</span>
            <span class="text-[15px] font-medium text-muted ml-2" v-else-if="$i18n.locale === 'zh'">{{ t('mcm.grade') }}{{ t('gradeLabel') }}</span>
          </h4>
          <p>{{ t('mcm.description') }}</p>
        </div>
        <div id="thesis" class="course-section relative mt-8 scroll-mt-[72px]">
          <h4 class="mb-0 mt-4 cursor-pointer select-none">{{ t('graduationThesis.title') }}
            <span class="text-[15px] font-medium text-muted ml-2" v-if="$i18n.locale === 'en'">{{ t('gradeLabel') }}{{ t('graduationThesis.grade') }}</span>
            <span class="text-[15px] font-medium text-muted ml-2" v-else-if="$i18n.locale === 'zh'">{{ t('graduationThesis.grade') }}{{ t('gradeLabel') }}</span>
          </h4>
...
@keyframes highlight-fade {
  ...
  10% { background-color: var(--c-primary-bg); }
  90% { background-color: var(--c-primary-bg); }
  100% { background-color: transparent; }
}

/* Wide layout: sidebar + content grid */
