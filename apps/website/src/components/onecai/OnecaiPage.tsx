...
import type {
  OnecaiPageCopy,
  OnecaiSectionContent
} from '@/i18n/pages/onecai/types';
...
interface OnecaiPageProps {
  text: OnecaiPageCopy;
  lang: Locale;
}

export default function OnecaiPage({ text, lang }: OnecaiPageProps) {
  ...
  const renderSectionText = (sectionId: string, content: OnecaiSectionContent[]) => {
    return (
