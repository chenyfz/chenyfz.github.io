...
<template>
  <div class="portfolio-page">
    ...
    <div class="content">
      ...
      <i18n-paragraphs :length="1" t-key="portfolioMsg.mcspParagraphs" />

      <h4 id="mlhvl-title">{{ $t('portfolioMsg.mlhvlTitle') }}</h4>

      <i18n-paragraphs :length="1" t-key="portfolioMsg.mlhvlParagraphs" />
      <h4 id="mvis-title">{{ $t('portfolioMsg.mvisTitle') }}</h4>
      <i18n-paragraphs :length="1" t-key="portfolioMsg.mvisParagraphs" />
      <a href="https://superfashion.walzen.org/" class="link" target="_blank">{{ $t('portfolioMsg.mvisParagraphs[1]') }}</a>
      ...
      <i18n-paragraphs :length="1" t-key="portfolioMsg.mqlmParagraphs" />
      <a href="/Group_30_Final_Paper.pdf" class="link" target="_blank">{{ $t('portfolioMsg.mqlmParagraphs[1]') }}</a>
      ...
      <i18n-paragraphs :length="1" t-key="portfolioMsg.mmmiParagraphs" />
      <a href="/INFOMMMI_Super_VR_Power_paper.pdf" class="link" target="_blank">{{ $t('portfolioMsg.mmmiParagraphs[1]') }}</a>
      <video controls>
      ...
      <i18n-paragraphs :length="1" t-key="portfolioMsg.mqnmParagraphs" />
      <a href="/infomqnm-report.pdf" class="link" target="_blank">{{ $t('portfolioMsg.mqnmParagraphs[1]') }}</a>
